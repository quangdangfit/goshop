...
func (_m *UserService) ChangePassword(ctx context.Context, id string, req *dto.ChangePasswordReq) error {
...
func (_m *UserService) Login(ctx context.Context, req *dto.LoginReq) (*model.User, string, string, error) {
...
func (_m *UserService) RefreshToken(ctx context.Context, userID string) (string, error) {
...
func (_m *UserService) Register(ctx context.Context, req *dto.RegisterReq) (*model.User, error) {
	ret := _m.Called(ctx, req)
