...
func (_m *CartService) AddProduct(ctx context.Context, req *dto.AddProductReq) (*model.Cart, error) {
...
func (_m *CartService) GetCartByUserID(ctx context.Context, userID string) (*model.Cart, error) {
...
func (_m *CartService) RemoveProduct(ctx context.Context, req *dto.RemoveProductReq) (*model.Cart, error) {
	ret := _m.Called(ctx, req)
