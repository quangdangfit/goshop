...
func (_m *OrderService) CancelOrder(ctx context.Context, orderID string, userID string) (*model.Order, error) {
...
func (_m *OrderService) GetMyOrders(ctx context.Context, req *dto.ListOrderReq) ([]*model.Order, *paging.Pagination, error) {
...
func (_m *OrderService) PlaceOrder(ctx context.Context, req *dto.PlaceOrderReq) (*model.Order, error) {
	ret := _m.Called(ctx, req)
