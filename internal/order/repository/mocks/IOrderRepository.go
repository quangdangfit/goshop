...
func (_m *OrderRepository) CreateOrder(ctx context.Context, userID string, lines []*model.OrderLine) (*model.Order, error) {
...
func (_m *OrderRepository) GetMyOrders(ctx context.Context, req *dto.ListOrderReq) ([]*model.Order, *paging.Pagination, error) {
...
func (_m *OrderRepository) GetOrderByID(ctx context.Context, id string, preload bool) (*model.Order, error) {
