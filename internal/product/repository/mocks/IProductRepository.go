...
func (_m *ProductRepository) Create(ctx context.Context, product *model.Product) error {
...
func (_m *ProductRepository) GetProductByID(ctx context.Context, id string) (*model.Product, error) {
...
func (_m *ProductRepository) ListProducts(ctx context.Context, req *dto.ListProductReq) ([]*model.Product, *paging.Pagination, error) {
...
func (_m *ProductRepository) Update(ctx context.Context, product *model.Product) error {
	ret := _m.Called(ctx, product)
