...
func (_m *ProductService) Create(ctx context.Context, req *dto.CreateProductReq) (*model.Product, error) {
...
func (_m *ProductService) GetProductByID(ctx context.Context, id string) (*model.Product, error) {
...
func (_m *ProductService) ListProducts(c context.Context, req *dto.ListProductReq) ([]*model.Product, *paging.Pagination, error) {
	ret := _m.Called(c, req)
...
func (_m *ProductService) Update(ctx context.Context, id string, req *dto.UpdateProductReq) (*model.Product, error) {
