...
func (_m *Redis) Get(key string, value interface{}) error {
...
func (_m *Redis) IsConnected() bool {
	ret := _m.Called()
...
func (_m *Redis) Keys(pattern string) ([]string, error) {
...
func (_m *Redis) Remove(keys ...string) error {
...
func (_m *Redis) RemovePattern(pattern string) error {
	ret := _m.Called(pattern)
...
func (_m *Redis) Set(key string, value interface{}) error {
	ret := _m.Called(key, value)
...
func (_m *Redis) SetWithExpiration(key string, value interface{}, expiration time.Duration) error {
